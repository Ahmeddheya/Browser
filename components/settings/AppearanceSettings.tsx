...
interface AppearanceSettingsProps {
  ...
  onSettingChange: (key: keyof AppearanceSettingsType, value: any) => void;
  onBack: () => void;
}
...
export const AppearanceSettings: React.FC<AppearanceSettingsProps> = ({
  ...
  const themeOptions = [
    { id: 'system', title: 'System default', subtitle: 'Follow device theme' },
    { id: 'light', title: 'Light', subtitle: 'Always use light theme' },
    { id: 'dark', title: 'Dark', subtitle: 'Always use dark theme' },
  ];
